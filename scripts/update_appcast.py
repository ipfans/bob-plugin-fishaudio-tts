...
def update_appcast(message):
    ...
    release_file = Path(f"release/bob-plugin-fishaudio-tts.bobplugin")
    ...
    version_info = {
        ...
        "desc": message,
        "sha256": file_hash,
        "url": f"https://github.com/ipfans/bob-plugin-fishaudio-tts/releases/download/v{version}/bob-plugin-fishaudio-tts_v{version}.bobplugin",
        "minBobVersion": "0.5.0",
    }
    ...
    if appcast_file.is_file():
        ...
        appcast = dict(identifier="com.acgso.bob-plugin-fishaudio-tts", versions=[])
